              ...
              <section className="relative max-w-5xl animate-in fade-in duration-1000 mb-16">
                  ...
                  <div className="flex flex-col lg:flex-row gap-6 lg:gap-16">
                    ...
                    <div className="flex-1 animate-in fade-in duration-1000 delay-300">
                      ...
                      <p className="text-xl sm:text-2xl text-gray-700 dark:text-gray-200 leading-relaxed">
                        ...
                        makes it easy for you to discover everything you need to
                        know about technical documentation, communication, and
                ...
                <div className="animate-in fade-in duration-1000 delay-500">
                  ...
                  <p className="hidden lg:block text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-16">
                    ...
                    intersect, work together, and remain relevant. We explore
                    the connections between technical writing, documentation
                    patterns, and communication principles that often remain
                    unexplored. This is the journey we embark on together.
                  </p>
